...
public abstract class MtGuiBase extends GuiContainer { //I'll just implement all this code because I don't have the time to build one from scratch and I just want to get this mod working
	...
	public MtGuiBase(Container container) {
		super(container);
